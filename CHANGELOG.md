...
- Add first-party GitHub Release installer distribution with stable repobird.ai entrypoints and checksum verification.

## [0.9.0] - 2026-06-25

### Added

- Add CLI support and docs for GitLab stored credential references and provider routing fields in run requests.

## [0.8.2] - 2026-06-19

### Changed

- Sync the Pro cloud-agent preset and documentation with the current GLM 5.2 OpenCode model default.
...
[Unreleased]: https://github.com/RepoBird/repobird-cli/compare/v0.10.0...HEAD
[0.10.0]: https://github.com/RepoBird/repobird-cli/compare/v0.9.0...v0.10.0
[0.9.0]: https://github.com/RepoBird/repobird-cli/compare/v0.8.2...v0.9.0
[0.8.2]: https://github.com/RepoBird/repobird-cli/compare/v0.8.1...v0.8.2
