...
// clearAllFields has been moved to create_input.go
...
// initErrorFocus has been moved to create_input.go  
...
// View renders the create view - implementation is in create_rendering.go
func (v *CreateRunView) View() string {
	return "CreateRunView - rendering functions are in create_rendering.go"
}