...
curl -L https://github.com/RepoBird/repobird-cli/releases/download/latest/repobird-cli_darwin_arm64.tar.gz | tar xz
sudo mv repobird /usr/local/bin/

# For Intel Macs
curl -L https://github.com/RepoBird/repobird-cli/releases/download/latest/repobird-cli_darwin_amd64.tar.gz | tar xz
sudo mv repobird /usr/local/bin/
```
...
curl -L https://github.com/RepoBird/repobird-cli/releases/download/latest/repobird-cli_linux_amd64.tar.gz | tar xz
sudo mv repobird /usr/local/bin/
```
